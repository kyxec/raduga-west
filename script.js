...
const translations = {
    ru: {
        ...
        checkin_step2_desc: "Сообщите администратору на ресепшене свои данные и номер 506. Вам выдадут ключи от номера. Постельное белье, полотенца и желтые браслеты уже будут находиться в номере.",
        ...
        amenities_comfort_desc: "Мощный кондиционер для регулировки климата, плоский телевизор, удобная обеденная зона.",
        ...
        spa_service_desc: "Расслабьтесь телом и душой. К услугам гостей профессиональный массаж и физиопроцедуры.",
    ...
    kg: {
        ...
        checkin_step2_desc: "Ресепшендеги администраторго маалыматыңызды жана 506-бөлмөнү айтыңыз. Сизге бөлмөнүн ачкычтары берилет. Шейшептер, сүлгүлөр жана сары билериктер бөлмөдө болот.",
    ...
    en: {
        ...
        checkin_step2_desc: "State your details and room number 506 to the receptionist at the front desk. They will provide room keys. Bed linen, towels, and yellow wristbands will already be inside the room.",
