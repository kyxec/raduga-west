/* ==========================================================================
   TRANSLATION ENGINE & DICTIONARY DATA
   ========================================================================== */
const translations = {
    ru: {
        meta_title: "Радуга Вест — Номер 506 | Гостевой гид",
        meta_desc: "Информационный буклет для гостей номера 506 в пансионате «Радуга Вест». Инструкции по заселению, пляжу, ресторанам, SPA и контакты для уборки.",
        nav_checkin: "🚗 Заселение",
        nav_location: "📍 Как добраться",
        nav_amenities: "🛌 Удобства",
        nav_dining: "🍽️ Рестораны",
        nav_spa: "🌊 СПА & Бассейн",
        nav_contacts: "📞 Помощь",
        hero_title: "Добро пожаловать в пансионат «Радуга Вест»!",
        hero_subtitle: "Все, что нужно знать для вашего идеального отдыха в номере 506",
        hero_btn_checkin: "Инструкция по заезду",
        hero_btn_contact: "Помощь & Уборка",
        ...
        checkin_step1_badge: "Номер: 506",
        checkin_step2_title: "Получение ключей и браслетов",
        checkin_step2_desc: "Сообщите администратору свои данные и номер 506. Вам выдадут ключи от номера, постельное белье, полотенца и желтые браслеты.",
        ...
        checkin_step3_desc: "Выезд из номера осуществляется строго до 12:00. При выезде не забудьте вернуть ключи и браслеты на ресепшен.",
        ...
        location_qr_sub: "Отсканируйте камерой телефона",
        ...
        amenities_kitchen_desc: "В номере установлены холодильник, микроволновая печь, электрочайник, мойка, посуда и столовые приборы.",
        amenities_comfort_title: "Климат и ТВ",
        amenities_comfort_status: "Кондиционер & Smart TV",
        amenities_comfort_desc: "Мощный кондиционер для регулировки климата, плоский телевизор с кабельными каналами, удобная обеденная зона.",
        dining_title: "Кафе и рестораны комплекса",
        dining_intro: "На обширной территории «Радуга Вест» работают несколько популярных заведений, предлагающих разнообразие кулинарных изысков:",
        dining1_title: "Madam Chen",
        ...
        spa_service_desc: "Расслабьтесь телом и душой. К услугам гостей профессиональные массажисты, физиопроцедуры, грязелечение и омолаживающие программы.",
    ...
    kg: {
        meta_title: "Радуга Вест — Бөлмө 506 | Коноктор үчүн гид",
        meta_desc: "«Радуга Вест» пансионатындагы 506-бөлмөнүн коноктору үчүн маалыматтык сайт. Катталуу, пляж, ресторандар, SPA эрежелери жана тазалоо боюнча байланыштар.",
        nav_checkin: "🚗 Катталуу",
        nav_location: "📍 Жол көрсөткүч",
        nav_amenities: "🛌 Шарты",
        nav_dining: "🍽️ Ресторандар",
        nav_spa: "🌊 СПА & Бассейн",
        nav_contacts: "📞 Жардам",
        hero_title: "«Радуга Вест» пансионатына кош келиңиздер!",
        hero_subtitle: "506-бөлмөдө жагымдуу эс алууңуз үчүн керек болгон бардык маалыматтар",
        hero_btn_checkin: "Катталуу нускамасы",
        hero_btn_contact: "Жардам & Тазалоо",
        ...
        checkin_step1_badge: "Бөлмө номери: 506",
        checkin_step2_title: "Ачкычтарды жана билериктерди алуу",
        checkin_step2_desc: "Администраторго маалыматыңызды жана 506-бөлмөнү айтыңыз. Сизге ачкычтар, шейшептер, сүлгүлөр жана сары билериктер берилет.",
        ...
        checkin_step3_desc: "Бөлмөдөн чыгуу саат 12:00гө чейин жүргүзүлөт. Чыгып жатканда ачкычтарды жана билериктерди кайра ресепшенге тапшырууну унутпаңыз.",
        ...
        location_qr_sub: "Телефон камерасы менен сканерлеңиз",
        ...
        amenities_kitchen_desc: "Бөлмөдө муздаткыч, микротолкундуу меш, электр чайнеги, жуугуч, идиш-аяктар жана идиш жуучу каражаттар бар.",
        amenities_comfort_title: "Климат жана ТВ",
        amenities_comfort_status: "Кондиционер & Smart TV",
        amenities_comfort_desc: "Абаны жөндөө үчүн кубаттуу кондиционер, кабелдик каналдары бар жалпак телевизор жана ыңгайлуу тамактануучу жай.",
        dining_title: "Аймактагы кафе жана ресторандар",
        dining_intro: "«Радуга Вест» аймагында кулинардык түрдүүлүктү сунуш кылган бир нече популярдуу жайлар иштейт:",
        dining1_title: "Madam Chen",
        ...
        spa_service_desc: "Денеңизди жана жан дүйнөңүздү эс алдырыңыз. Коноктор үчүн профессионалдык массаж, физиопроцедуралар жана жашартуу программалары бар.",
    ...
    en: {
        meta_title: "Raduga West — Room 506 | Guest Guide",
        meta_desc: "Guest information website for room 506 at the Raduga West resort. Directions, check-in instructions, beaches, restaurants, spa, and housekeeping support.",
        ...
        nav_spa: "🌊 SPA & Pool",
        nav_contacts: "📞 Help",
        hero_title: "Welcome to Raduga West Resort!",
        hero_subtitle: "Everything you need to know for your perfect stay in room 506",
        hero_btn_checkin: "Check-in Instructions",
        hero_btn_contact: "Help & Housekeeping",
        ...
        checkin_step1_badge: "Room: 506",
        checkin_step2_title: "Obtaining Keys & Wristbands",
        checkin_step2_desc: "State your details and room number 506 to the staff. They will provide keys, bed linen, towels, and yellow wristbands.",
        ...
        checkin_step3_desc: "Check-out time is strictly before 12:00. Upon departure, remember to return all keys and wristbands to reception.",
        ...
        location_qr_sub: "Scan with your phone's camera",
        ...
        amenities_kitchen_desc: "The room is equipped with a refrigerator, microwave oven, electric kettle, sink, dinnerware, and cutlery.",
        amenities_comfort_title: "AC & Smart TV",
        amenities_comfort_status: "AC & Smart TV",
        amenities_comfort_desc: "Powerful air conditioner for climate control, flat-screen television with cable channels, and a cozy dining table.",
        dining_title: "On-site Dining & Cafes",
        dining_intro: "Several popular dining spots are located across the territory of Raduga West, offering a variety of cuisines:",
        dining1_title: "Madam Chen",
        ...
        spa_service_desc: "Indulge in relaxation. Guests can book professional massages, physical therapy, healing mud wraps, and beauty programs.",
...
function setLanguage(lang) {
    ...
    const metaDescTag = document.getElementById('meta-desc');
    if (metaDescTag) {
        metaDescTag.setAttribute('content', translations[lang].meta_desc);
    }
    
    // Update text content of translating elements
    ...
    // Update active visual language buttons
...
/* ==========================================================================
   INTERSECTION OBSERVER (SCROLL HIGHLIGHTS IN NAVIGATION)
   ========================================================================== */
...
const observerOptions = {
    root: null,
    rootMargin: '-30% 0px -60% 0px', // Center-biased threshold for mobile
    threshold: 0
};
